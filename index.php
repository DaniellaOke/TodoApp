    ...
    <div class="container py-5 h-100">
        ...
        <div class="col col-xl-10">
            ...
            <div class="card-body p-5">
                ...
                <form method="post" action="todo.php" class="d-flex justify-content-center align-items-center mb-4">
                ...
                <ul class="list-group mb-0">
                    ...
                    <li
                        ...
                        <form action="todo.php" method="post" style="margin-right: 10px;">
                        ...
                        <a href="/todo.php?action=delete&id=<?php echo $row['id'] ?>" data-mdb-tooltip-init title="Remove item">
